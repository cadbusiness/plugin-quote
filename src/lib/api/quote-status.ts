/** Shared CRM ↔ MCP helpers for devis v0 (status slice + autopilot gate). */
...
/** Autopilot (quote.submitted workflows / emails) is off unless explicitly true. */
export function shouldRunQuoteAutopilot(runAutopilot: unknown): boolean {
  return runAutopilot === true || runAutopilot === "true" || runAutopilot === 1 || runAutopilot === "1";
}
