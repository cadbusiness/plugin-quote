...
export const MARKETING_ROUTES: MarketingRoute[] = [
  ...
  { path: "/blog/espace-prospect-devis-en-ligne", changeFrequency: "monthly", priority: 0.8 },
  ...
  { path: "/outils/estimateur-valeur-pipeline-devis", changeFrequency: "monthly", priority: 0.7 },
