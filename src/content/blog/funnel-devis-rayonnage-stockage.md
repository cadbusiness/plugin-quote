...
## Le catalogue, pas la brochure

Une plaquette PDF sur le site ne suffit plus dès que vous avez trois gammes. Le [catalogue](/fonctionnalites/catalogue) QuoteBuilder porte les références que vous savez poser, avec min / max, tags, activation. Les règles Si/Alors font le travail du commercial junior : usage alimentaire → inox ; allée étroite → une profondeur ; charge > X → une série.

Si les fiches existent déjà dans WooCommerce ou Shopify, [synchronisez](/blog/sync-catalogue-woocommerce-shopify-parcours-devis). N’ouvrez pas un troisième tarif. Désactivez ce qui n’a rien à faire dans un projet (consommables, pièces détachées) : deux CTA, deux funnels si besoin.

## Du dossier au chantier (presque)

À la soumission, la [demande](/fonctionnalites/demandes) n’est plus un e-mail. Statut, score, assignation, notes, timeline. La ligne ouvre la fiche. Un Hot « 800 m², 800 kg, délai 6 semaines » passe devant un Cold « on se renseigne ». Les abandons avec e-mail restent relançables.

L’[espace prospect](/fonctionnalites/espace-prospect) évite les plans envoyés sur trois messageries. Lien, PIN, barre de statut, dépôt de photos. Le poseur et l’acheteur voient le même dossier.

L’[autopilote](/fonctionnalites/autopilote) envoie ce que le cycle stockage exige : confirmation + récap T+0, rappel interne à 4 h si personne n’a touché, point à 24 h, relance J+3, angle métier J+7 (souvent charge ou délai), réactivation J+30. Générez le texte avec le [générateur](/outils/generateur-sequence-relances), puis passez-le en parcours actif.

## Ads : mesurer le devis, pas le clic

Le stockage se cherche encore beaucoup via Google (« rayonnage industriel 400 kg », « cantilever occasion », « installation racking entrepôt »). QuoteBuilder ne gère pas les enchères. Il [ferme la boucle](/fonctionnalites/ads) : UTM, gclid, conversion à la soumission, conversion au gagné, coût par devis et par client. Les templates de mots-clés secteur existent pour coller dans Ads, pas pour reconstruire un manager de campagnes.

Sans funnel, vous optimisez des leads « contactez-nous ». Avec funnel, vous optimisez des briefs. Le [calculateur](/outils/cout-devis-non-relance) relie ensuite le closing au CA.

## Installer sur le site actuel

La plupart des rayonnagistes ont déjà un WordPress, parfois Woo. [Deux lignes de JS ou le plugin](/blog/installer-widget-devis-wordpress-javascript). Page /devis dédiée pour les campagnes. Bouton sur les fiches gammes pour le trafic organique. Le formulaire footer reste pour le SAV et les pièces.
...
## Revendeur, fabricant, installateur

Le même funnel ne parle pas à tout le monde.

Le **revendeur** a plusieurs marques. Il active des gammes, pas une production. Le score sert à savoir s’il faut une visite ou un tarif mail.

Le **fabricant** a des délais et des exceptions. Les questions délai et volume pèsent plus. Une branche autopilote peut assigner le BE plutôt que le commercial sédentaire.

L’**installateur** vit sur le site. La photo de l’existant et l’accès engins valent plus qu’une fourchette catalogue. L’espace prospect (plans, PIN) évite les WhatsApp perdus.

Agency existe pour les réseaux qui portent plusieurs enseignes. Un funnel par marque reste plus clair qu’un sélecteur « choisissez votre univers » de quinze logos.

## Objections terrain

« Nos clients veulent un commercial tout de suite. » Donnez le téléphone en bas de page. Le funnel n’interdit pas l’appel. Il fait que l’appel commence à l’étape 4, pas à l’étape 0.

« Chaque entrepôt est unique. » Oui. C’est pour ça que le 3D et la note de calcul restent humains. Le funnel n’a pas à tout résoudre. Il a à cesser de commencer à zéro.

« On a déjà un configurateur Excel. » Excel n’a pas d’abandon identifiable, pas d’UTM, pas de relance, pas d’espace prospect. Gardez-le en coulisse si le tarif y est. Ne l’offrez plus comme unique porte d’entrée.
