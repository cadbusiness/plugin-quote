...
description: "Visite guidée d’un parcours devis B2B : funnel public, boutique, pipeline, dossier devis, catalogue, automations et relances. Captures démo et checklist de mise en place."
canonical: /blog/visite-guidee-parcours-devis-b2b
locale: fr-FR
...
**Essayer le parcours maintenant :** [ouvrir la démo funnel](https://www.quotebuilder.co/c/demo/rayonnage) (sans compte), ou [créer un compte Free](https://www.quotebuilder.co/signup?plan=free) pour voir l’espace vendeur (pipeline, dossiers, relances).


## Le problème : message vs dossier

Un **message** dit « je voudrais un devis ».  
Un **dossier devis** dit : quels produits ou gammes, quelles contraintes, quelle surface, quelle charge, quel délai, quelle fourchette, d’où vient la demande, et qui doit répondre en premier.
...
Si vous hésitez encore entre formulaire contact et funnel, lisez d’abord [formulaire de contact vs funnel de devis B2B](/blog/formulaire-contact-vs-funnel-devis-b2b). Ici, on suppose que vous voulez voir le parcours **en vrai**, écran par écran.
...
![Funnel public rayonnage, étape 1 type de projet](/images/blog/visite-guidee-parcours-devis-b2b/09-public-funnel.png)
*Funnel public `/c/demo/rayonnage` : étape 1 sur 5, choix du type d’espace.*
...
Vous pouvez tester le parcours live : [démo funnel rayonnage](https://www.quotebuilder.co/c/demo/rayonnage).

> Astuce. Commencez le funnel par une question que le prospect sait répondre en 5 secondes (type d’espace, usage, gamme). Gardez les détails techniques pour plus tard. Un premier écran trop pointu augmente l’abandon avant même le score.
...
![Boutique publique Espace démo, catalogue et CTA devis](/images/blog/visite-guidee-parcours-devis-b2b/10-public-boutique.png)
*Boutique `/b/demo/vitrine` : catalogue, rayons, produits, CTA « Demander un devis ».*
...
Live : [boutique démo](https://www.quotebuilder.co/b/demo/vitrine).
...
> Attention. Un score élevé sans owner et sans première réponse rapide ne sert à rien. Hot 91 qui attend 8 jours devient un dossier brûlé. Le pipeline affiche la priorité ; l’équipe doit encore exécuter le SLA. Voir aussi [score demande devis B2B](/blog/score-demande-devis-b2b).
...
Pour tester la qualité d’un brief avant même d’ouvrir un outil lourd, vous pouvez aussi passer un cas dans le [score brief devis](/outils/score-brief-devis).
...
**Passer du guide à l’outil :** si le dossier détaillé ci-dessus ressemble à ce que vous voulez obtenir sur chaque demande, [créez un compte Free](https://www.quotebuilder.co/signup?plan=free) ou rejouez le [parcours démo rayonnage](https://www.quotebuilder.co/c/demo/rayonnage) avec un cas réel de votre catalogue.
...
Pour une synchro e-commerce plus large, voir [sync catalogue WooCommerce / Shopify et parcours devis](/blog/sync-catalogue-woocommerce-shopify-parcours-devis).
...
Même avec un beau dossier, le silence tue. Les benchmarks de suivi B2B rappellent depuis longtemps qu’une grande part des ventes demande **plusieurs touches**, alors que beaucoup d’équipes s’arrêtent après une ou deux. Pour le détail et les sources, voir [pourquoi les devis meurent sans relance](/blog/pourquoi-les-devis-meurent-sans-relance).
...
![Automatisations : parcours demande et abandon](/images/blog/visite-guidee-parcours-devis-b2b/05-automations.png)
*Automatisations `/automations` : parcours actifs sur soumission et abandon.*

Deux familles utiles dès le jour 1 :

1. **Parcours demande** (déclencheur soumission) : confirmation immédiate au prospect, notification owner, éventuellement première relance T+1 ou T+2 selon le score.
2. **Parcours abandon** (déclencheur abandon) : récupérer ceux qui ont commencé le funnel sans finir, avec un message lié au brief partiel, pas un « just checking in ».

> Astuce. Automatisez le calendrier et la confirmation, pas le jugement commercial. Les Hot avec une question ouverte (visite sur site, appel décideur) restent en action manuelle. Les Warm et les abandons supportent mieux une cadence écrite. Si vous partez de zéro, générez une base de séquence via le [générateur de séquence de relances](/outils/generateur-sequence-relances).
...
**1. Clarifier l’offre exposée**  
Listez 1 famille prioritaire (ex. rayonnage). Décidez ce qui est prix catalogue vs à chiffrer.

**2. Nettoyer le catalogue**  
SKU, photos, fourchettes. Traitez d’abord les « sans prix » visibles dans le bandeau catalogue. Branchez Woo / Shopify si c’est déjà votre source, ou créez une boutique hébergée.

**3. Publier un funnel public**  
5 à 7 étapes max pour le premier jet. Première question simple. Dernière étape = récap + coordonnées. Testez sur mobile. Lien type `/c/...`.

**4. (Option) Publier une vitrine**  
Si le prospect cherche par référence. CTA unique vers devis. Prix affichés = fourchettes, FAQ honnête sur le « pas de panier de commande ».

**5. Définir score + SLA**  
Grille simple Hot / Warm / Cold (voir [score demande](/blog/score-demande-devis-b2b)). Owner par défaut. SLA : Hot le jour même, Warm sous 24–48 h.

**6. Brancher 2 automations**  
Confirmation à la soumission. Relance abandon. Plus tard : séquence post-devis. Mesurez les touches réellement faites.

**7. Tenir la file Demandes**  
Revue quotidienne de la liste filtrée Hot + « sans réponse ». Ouvrir le dossier, pas le fil mail. Clore proprement les morts pour garder un pipeline lisible.

**8. Itérer sur les questions du funnel**  
Regardez où les gens abandonnent. Une question trop tôt ou trop technique coûte plus cher qu’un champ en moins sur un formulaire classique.
...
En général non. Montrez un récap du brief et les prochaines étapes. Le score (Hot / Warm / Cold) sert à l’équipe pour allouer le temps. Détails dans [score demande devis B2B](/blog/score-demande-devis-b2b).
...
Non. Elles portent la confirmation, les rappels et une partie des Warm / abandons. Les Hot complexes, les multi-décideurs et les objections restent du travail commercial. L’objectif est d’éviter le trou entre « devis envoyé » et « devis oublié », voir [pourquoi les devis meurent sans relance](/blog/pourquoi-les-devis-meurent-sans-relance).

### Par où tester sans reconstruire tout mon site ?

Ouvrez le [funnel démo rayonnage](https://www.quotebuilder.co/c/demo/rayonnage) et la [boutique démo](https://www.quotebuilder.co/b/demo/vitrine), puis comparez avec votre formulaire actuel sur un cas réel. Si le brief sort plus chiffrable, vous avez votre réponse. Côté produit : [comment ça marche](/comment-ca-marche), [fonctionnalités](/fonctionnalites), [tarifs](/tarifs).

## Conclusion

Passer de la demande floue au dossier devis, ce n’est pas une punchline. C’est une chaîne visible dans les écrans :

1. le prospect avance dans un **funnel** ou une **vitrine** ;
2. la soumission crée une **demande scorée** dans l’accueil et la liste ;
3. le commercial ouvre un **dossier** avec raisons, source, actions ;
4. le **catalogue** et les **intégrations** nourrissent le chiffrage ;
5. les **automations** portent confirmation et relances pour que le dossier ne meure pas en silence.

Si vous voulez voir le parcours de bout en bout : [démo funnel rayonnage](https://www.quotebuilder.co/c/demo/rayonnage) (côté prospect) et [essai gratuit](https://www.quotebuilder.co/signup?plan=free) (côté vendeur : pipeline, dossiers, automations). Puis comparez avec votre entrée actuelle : message libre ou brief structuré ? Une seule boîte mail ou une file Demandes ? Relances au feeling ou cadence écrite ?

**Prochaine étape :** [Essayer gratuitement](https://www.quotebuilder.co/signup?plan=free) ou [ouvrir la boutique démo](https://www.quotebuilder.co/b/demo/vitrine).

Pour aller plus loin : [formulaire vs funnel](/blog/formulaire-contact-vs-funnel-devis-b2b), [score demande](/blog/score-demande-devis-b2b), [devis sans relance](/blog/pourquoi-les-devis-meurent-sans-relance), [score brief](/outils/score-brief-devis).
