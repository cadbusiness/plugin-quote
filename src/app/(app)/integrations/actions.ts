...
export async function updateStorefront(formData: FormData) {
  ...
  const settings: ConnectionSettings = {
    ...
    storefront: parseStorefront({
      ...
      floatingLabel: String(formData.get("floatingLabel") ?? ""),
      floatingPosition: String(formData.get("floatingPosition") ?? "right"),
      showFloatingWhenEmpty: formData.get("showFloatingWhenEmpty") === "on",
      floatingBg: String(formData.get("floatingBg") ?? ""),
      floatingColor: String(formData.get("floatingColor") ?? ""),
      floatingBadge: String(formData.get("floatingBadge") ?? ""),
      ...
      drawerCta: String(formData.get("drawerCta") ?? ""),
      drawerCtaHint: String(formData.get("drawerCtaHint") ?? ""),
      drawerReassure: String(formData.get("drawerReassure") ?? ""),
      drawerEmpty: String(formData.get("drawerEmpty") ?? ""),
