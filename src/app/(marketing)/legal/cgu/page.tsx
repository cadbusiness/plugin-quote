    ...
    <article className="px-6 pb-20 pt-12 sm:pt-16">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-[16px] leading-7 text-[#1A1510]/75">
          <section>
            <h2 className="text-xl font-semibold tracking-tight text-[#1A1510]">1. Éditeur</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold tracking-tight text-[#1A1510]">2. Objet</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold tracking-tight text-[#1A1510]">3. Compte</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold tracking-tight text-[#1A1510]">4. Données des prospects</h2>
            <p className="mt-3">
              ...
              <Link href="/legal/confidentialite" className="font-medium text-[#E85D04] hover:underline">
          ...
          <section>
            <h2 className="text-xl font-semibold tracking-tight text-[#1A1510]">5. Disponibilité et responsabilité</h2>
            <p className="mt-3">
