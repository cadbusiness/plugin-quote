...
export const metadata: Metadata = pageMetadata({
  title: "Funnel de devis cuisine équipée : plans, typologie, pose et score",
  description:
    "Landing SEO cuisine équipée / professionnelle légère : funnel de devis (linéaire, U, îlot), plans, électroménager, pose, score Hot/Warm/Cold, assignation et relances.",
  path: "/secteurs/funnel-devis-cuisine-equipee",
});

const FAQ = [
  {
    q: "Faut-il toujours une visite avant devis cuisine ?",
    a: "Pas toujours pour une estimation. Oui souvent avant commande et pose. Le funnel doit distinguer « prix indicatif » et « devis ferme après relevé ».",
  },
  {
  ...
  },
  {
    ...
    a: "Non. Il prépare le brief pour que le dessinateur et le poseur ne perdent pas leur temps sur des incomplets.",
  },
  {
...
export default function CuisineEquipeeLandingPage() {
  const body = loadPostBody("funnel-devis-cuisine-equipee");
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Funnel de devis cuisine équipée : plans, typologie, pose et score",
    url: `${SITE_URL}/secteurs/funnel-devis-cuisine-equipee`,
    about: "Cuisine équipée, cuisiniste, îlot, plan de travail, électroménager, devis pose",
  ...
  return (
    <>
      ...
      <section className="px-6 pb-6 pt-12 sm:pt-16">
        <div className="mx-auto max-w-3xl">
          <p className="text-[12px] font-medium uppercase tracking-[0.14em] text-mk-accent">
            Secteur · Cuisine équipée
          </p>
          <h1 className="mt-3 text-[1.85rem] font-semibold tracking-tight sm:text-4xl sm:leading-tight">
            Funnel de devis cuisine équipée : plans, typologie, pose et score
          </h1>
          <p className="mt-4 text-[16px] leading-7 text-mk-muted sm:text-lg">
            Typologie, plans, électroménager, pose, plomberie / électricité. Un brief chiffrable, un
            score, un owner, puis des relances qui tiennent le planning de pose.
          </p>
      ...
      <MarketingCta
        title="Essayer le template cuisine"
        text="Un parcours typologie, plans, pose. Le plan Free suffit pour voir l’interface, sans carte."
      />
    </>
  );
}
