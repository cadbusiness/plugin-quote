...
Tant que la migration n’est pas appliquée, l’app affiche le seed bundlé (`src/lib/updates/seed.ts`, mêmes notes que 1.7 / 1.8 / 1.9 / 1.9.1 / 1.9.2 / 1.9.3 / 1.10.0 / 1.11.0 / 1.12.0) et mémorise le last-seen dans le cookie `qb-updates-seen`. Dès que les tables existent, elles deviennent la source de vérité.

Migrations : `0024_product_updates.sql` (tables + 1.7 / 1.8), `0025_product_update_1_9_0.sql` (1.9.0), `0026_product_update_1_9_1.sql` (1.9.1), `0027_product_update_1_9_2.sql` (1.9.2), `0028_product_update_1_9_3.sql` (1.9.3), `0029_product_update_1_10_0.sql` (1.10.0), `0030_product_update_1_11_0.sql` (1.11.0), `0031_product_update_1_12_0.sql` (1.12.0).
